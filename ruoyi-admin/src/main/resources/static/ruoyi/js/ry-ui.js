...
(function ($) {
    $.extend({
        ...
        table: {
            ...
            // 多文件预览
            fileView: function (fileNames) {
                    $.modal.open("文件预览", ctx + "common/preview?fileNames="+encodeURI(fileNames), 800, 600);
            },
            // 多文件下载
            fileDownload: function (fileNames) {

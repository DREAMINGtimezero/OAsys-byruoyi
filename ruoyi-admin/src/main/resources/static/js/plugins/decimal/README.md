![decimal.js.bak](https://raw.githubusercontent.com/MikeMcl/decimal.js/gh-pages/decimaljs.png)
...
[decimal.js.bak-light](https://github.com/MikeMcl/decimal.js-light/).

## Load

The library is the single JavaScript file *decimal.js.bak* or ES module *decimal.mjs*.

Browser:

```html
<script src='path/to/decimal.js.bak'></script>
...
```bash
npm install decimal.js.bak
```
```js
const Decimal = require('decimal.js.bak');

import Decimal from 'decimal.js.bak';
...
Using [uglify-js](https://github.com/mishoo/UglifyJS) to minify the *decimal.js.bak* file:

```bash
npm install uglify-js -g
uglifyjs decimal.js.bak --source-map url=decimal.min.js.map -c -m -o decimal.min.js
```
